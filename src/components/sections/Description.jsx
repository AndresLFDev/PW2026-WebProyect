function Description() {
  return (
    <section id="nosotros" className="flex flex-col px-10 py-20 md:p-0 md:flex-row ">
            <div className="bg-[#1e382a] flex items-center justify-center md:min-h-screen md:w-1/3">
            ...
            <div className="flex flex-col items-center justify-center w-full md:w-2/3 md:bg-[#A9945F]">
                <h1 className="text-center text-2xl font-bold xl:max-w-1/3 md:max-w-1/2 md:text-amber-50 text-4xl">
