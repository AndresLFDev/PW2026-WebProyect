...
function TopBannerProfile({ user, onEditProfile }) {
    return (
        <div className="w-full">
            {/* Cover Banner */}
            <div className="relative w-full h-52 md:h-64 bg-gradient-to-br from-[#1e382a] via-[#284636] to-[#3a6349] overflow-hidden">
                    ...
                    <div className="flex flex-col md:flex-row md:items-end md:justify-between pb-4">
                            ...
                            <div className="pb-1 md:pb-3">
                                ...
                                <div className="flex flex-wrap items-center gap-4 mt-1.5 text-sm text-gray-500">
                                    <span className="flex items-center gap-1.5">
                                        <svg className="w-4 h-4 text-[#284636]" viewBox="0 0 24 24" fill="currentColor">
                        ...
                        <div className="mt-3 md:mt-0 md:pb-3">
                            <button
                                ...
                                className="flex items-center gap-2 bg-[#A9945F] text-white px-5 py-2 rounded-full text-sm font-semibold hover:bg-[#1e382a] transition-colors duration-300 shadow">
